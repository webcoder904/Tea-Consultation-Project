        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold text-white">ExpertConnect</span>
            </Link>
            <p className="text-gray-400 mb-6 max-w-md leading-relaxed">
              Connecting farmers with agricultural experts worldwide. Get professional consultation 
              and transform your farming practices with expert guidance.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/experts" className="text-gray-400 hover:text-green-400 transition-colors">
                  Find Experts
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-2">
                ...
                <span className="text-gray-400">support@expertconnect.com</span>
              </li>
              <li className="flex items-center space-x-2">
